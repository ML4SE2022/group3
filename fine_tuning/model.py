...
class Seq2Seq(nn.Module):
    ...
    def forward(self, source_ids=None, source_mask=None, target_ids=None, target_mask=None, args=None):
        ...
        if target_ids is not None:
            ...
            tgt_embeddings = self.encoder.embeddings(target_ids).permute([1, 0, 2]).contiguous() if hasattr(self.encoder, "embeddings") else self.encoder.get_encoder().embed_tokens(target_ids).permute([1, 0, 2]).contiguous()
