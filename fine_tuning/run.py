...
from transformers import (WEIGHTS_NAME, AdamW, get_linear_schedule_with_warmup,
                          RobertaConfig, RobertaModel, RobertaTokenizer, PLBartConfig, PLBartModel, PLBartTokenizer)

MODEL_CLASSES = {'roberta': (RobertaConfig, RobertaModel, RobertaTokenizer), 'plbart': (PLBartConfig, PLBartModel, PLBartTokenizer)}
...
def main():
    ...
    if args.local_rank == -1 or args.no_cuda:
        device = torch.device("cuda" if torch.cuda.is_available() and not args.no_cuda else "cpu") # TODO: "cuda" if torch.cuda.is_available() and not args.no_cuda else
